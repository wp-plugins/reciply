...
<form name="optionform" enctype="multipart/form-data" method="post" action="options.php">
    ...
    <table class="form-table">
		...
		<input name="image" type="file" value="<?php echo get_option('image'); ?>" disabled="true" /><br>
		<input id="upload" type="submit" value="Upload" onclick="optionform.action='../wp-content/plugins/reciply/uploadImage.php'; return true;" disabled="true" />
		</td>
        </tr>
        </tr>		
    </table>    
